<%@ page import= "PPS_Project.bean.*,PPS_Project.DAO.Root_part3_DAO, PPS_Project.DAO.Transactions_DAO, java.util.List, javax.servlet.http.HttpSession " %>
...
Root_part3_DAO Root_DAO = new Root_part3_DAO();        
       // listed in attribute 'transactions list'
List <Transactions> transactions_list = Root_DAO.get_Biggest_Buyer();
%>
...
<div align="center">
        ...
        <table border="1" cellpadding="5">
			...
			<tr>
				   ...
				   <td>  <%=transaction.get_total_pps()%></td>
